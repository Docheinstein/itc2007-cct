...
char * solution_to_string(const solution *sol) {
    ...
    FOR_C {
        FOR_R {
            FOR_D {
                FOR_S {
                    if (solution_get_at(sol, c, r, d, s))
                        strappend_realloc(
...
int solution_soft_constraint_min_working_days(solution *sol) {
    ...
    FOR_C {
        ...
        FOR_D {
            ...
            FOR_R {
                FOR_S {
                    y_cd = y_cd || solution_get_at(sol, c, r, d, s);
                }
            }
...
int solution_soft_constraint_room_stability(solution *sol) {
    ...
    FOR_C {
        ...
        FOR_R {
            ...
            FOR_D {
                FOR_S {
                    w_cr = w_cr || solution_get_at(sol, c, r, d, s);
                }
            };
