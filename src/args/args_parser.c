...
static const char *argp_doc =
    ...
    "# Default: false\n"
    "solver.multistart=true|false\n"
    "\n"
    "# Restore the best solution so far after N non improving cycles.\n"
    "# Default: 15\n"
    "solver.restore_best_after_cycles=N\n"
    "\n"
